...
class PytorchStanfordCars(VisionDataset):
    ...
    def __init__(
        ...
        self._base_folder = os.path.join(root, "merging", "stanford_cars")
        ...
        if self._split == "train":
            ...
            self._images_base_path =  os.path.join(self._base_folder, "train")
        else:
            self._annotations_mat_path =  os.path.join(self._base_folder, "cars_test_annos_withlabels.mat")
            self._images_base_path =  os.path.join(self._base_folder, "test")
        ...
        self._samples = [
            ...
            for annotation in sio.loadmat(self._annotations_mat_path, squeeze_me=True)["annotations"] if os.path.join(self._images_base_path, annotation["fname"]) != "/vast/data/merging/stanford_cars/test/00248.jpg"
        ]
