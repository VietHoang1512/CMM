...
# Define prompt templates for ImageCLEF
imageclef_template = [
    lambda c: f'a photo of a {c}.',
    lambda c: f'an image of a {c}.',
    lambda c: f'a snapshot of a {c}.',
    lambda c: f'a clear picture of a {c}.',
    lambda c: f'an example of a {c} in a natural setting.',
]

# Define prompt templates for Office-Home
officehome_template = [
    lambda c: f'a photo of a {c} in an office setting.',
    lambda c: f'an image of a {c} at a workspace.',
    lambda c: f'a picture of a {c} in a modern office environment.',
    lambda c: f'a realistic photo of a {c} from the Office-Home dataset.',
    lambda c: f'a depiction of a {c} in a business context.',
]

office31_template = [
    lambda c: f'a photo of a {c} in an office environment.',
    lambda c: f'an image of a {c} on a desk.',
    lambda c: f'a snapshot of a {c} used in an office setting.',
    lambda c: f'a realistic photo of a {c} typically found in a workplace.',
    lambda c: f'a detailed shot of a {c} in a professional office.',
    lambda c: f'a clear picture of a {c} in an office space.',
]
...
dataset_to_template = {
    ...
    'SVHN': svhn_template,
    'ImageCLEF': imageclef_template,
    'OfficeHome': officehome_template,
    'Office31': office31_template,
}
