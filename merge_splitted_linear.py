...
from src.merging.task_vectors import TaskVector, merge_max_abs, merge_rnd_mix, last, LinearizedTaskVector, NonLinearTaskVector
...
if __name__ == '__main__':
    ...
    # name = f"merging-{args.dataset}-{args.n_splits}"
    ...
    #     name=name,
    #     config=args,
    #     tags=["merging", "CIL", f"{args.dataset}"],
    # )
    
    # preload task vectors
    task_vectors = [
        TaskVector(pretrained_checkpoint, f'{args.save}/finetuned_{_idx}.pt')
