...
class _Office31:
    ...
    DOMAINS = "amazon dslr webcam".split()
    CLASSES = "back_pack  bike_helmet  bottle      desk_chair  desktop_computer  headphones  laptop_computer  mobile_phone  mouse  paper_notebook  phone    projector  ring_binder  scissors  stapler         trash_can bike       bookcase     calculator  desk_lamp   file_cabinet      keyboard    letter_tray      monitor       mug    pen             printer  punchers   ruler        speaker   tape_dispenser".split()
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, subset_config=None):
        ...
        """
        # Base dataset path
        self.root = os.path.join(root, 'Office31')
