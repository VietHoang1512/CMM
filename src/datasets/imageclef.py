...
class _ImageCLEF:
    # Default global domains and classes
    DOMAINS = ['b', 'c', 'i', 'p']
    CLASSES = "aeroplane bike bird boat boele bus car dog horse monitor motorbike people".split()
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None, subset_config=None):
        ...
        """
        # Base dataset path
        self.root = os.path.join(root, 'image-clef')
