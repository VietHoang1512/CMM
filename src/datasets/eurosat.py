...
class EuroSATBase:
    def __init__(self,
        ...
        # Data loading code
        traindir = os.path.join(location, 'merging', 'EuroSAT_Splitted', 'train')
        #  TODO: this is a hack
        # traindir = os.path.join(location, 'EuroSAT_Splitted', test_split)
        
        testdir = os.path.join(location, 'merging', 'EuroSAT_Splitted', test_split)
